    ...
    return (  
        ...
        <Modal.Header closeButton>
          <Modal.Title id="contained-modal-title-vcenter">
                {props.errorOwner && <div>{props.errorOwner}</div>}
                {props.isLoadingOwner && <div>Loading user...</div>}
                {props.owner && <>Reply to {props.owner.username}'s comment</>}
          </Modal.Title>
        </Modal.Header>
        <Modal.Body>
        <div className="d-flex flex-row align-items-center"> 
                {props.errorOwner && <div>{props.errorOwner}</div>}
                {props.isLoadingOwner && 
                ...
                {props.owner && props.owner.profilePicture ?
                    <img 
                        src={props.owner.profilePicture} 
                        alt={props.owner.username + " profile picture"} 
