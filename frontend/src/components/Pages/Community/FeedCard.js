            ...
            <div className="d-flex flex-row justify-content-between mb-2 mt-1 mx-4">
                <div className="d-flex flex-row justify-content-center">
                    {(props.isLoggedIn.loggedIn && props.post.likes.includes(props.isLoggedIn.user._id)) ? 
                        <div className="d-flex flex-row justify-content-center">
                            <svg id={`like-button-${id}`} onClick={() => vote('like')} xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="me-1 vote-btn bi bi-hand-thumbs-up-fill" viewBox="0 0 16 16">
                        ...
                        :
                        <div className="d-flex flex-row justify-content-center">
                            <svg id={`like-button-${id}`} onClick={() => vote('like')} xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="me-1 vote-btn bi bi-hand-thumbs-up" viewBox="0 0 16 16">
                    ...
                    {/* <div className="d-flex flex-row justify-content-center">
                        <svg className="me-1" xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-hand-thumbs-down" viewBox="0 0 16 16">
                    ...
                    {(props.isLoggedIn.loggedIn && props.post.dislikes.includes(props.isLoggedIn.user._id)) ? 
                        <div className="d-flex flex-row justify-content-center">
                            <svg id={`dislike-button-${id}`} onClick={() => vote('dislike')} xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="me-1 vote-btn bi bi-hand-thumbs-down-fill" viewBox="0 0 16 16">
                        ...
                        :
                        <div className="d-flex flex-row justify-content-center">
                            <svg id={`dislike-button-${id}`} onClick={() => vote('dislike')} xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="me-1 vote-btn bi bi-hand-thumbs-down" viewBox="0 0 16 16">
                    ...
                    {(props.isLoggedIn.loggedIn) ? 
                        <div className="d-flex flex-row justify-content-center">
                            <svg onClick={() => sharePost(props.post.title, props.post.image, props.post.description)} xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="me-1 vote-btn bi bi-hand-thumbs-down-fill" viewBox="0 0 16 16">
                ...
                <HashLink smooth to={`/community/${props.post._id}#comment-section`} elementid={'#comment-section'} style={{color: 'inherit', textDecoration: 'inherit'}}>
                    <div className="d-flex flex-row justify-content-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="me-1 bi bi-chat-right-dots" viewBox="0 0 16 16">
