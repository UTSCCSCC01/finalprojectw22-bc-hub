            ...
            <div className="d-flex flex-row justify-content-between mb-2 mt-1 mx-4">
                <div className="d-flex flex-row justify-content-center">
                    ...
                    {(props.isLoggedIn.loggedIn) ? 
                        <div className="d-flex flex-row justify-content-center">
                            <svg onClick={() => sharePost(props.post.title, props.post.image, props.post.description)} className="me-1" xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="vote-btn bi bi-hand-thumbs-down-fill" viewBox="0 0 16 16">
